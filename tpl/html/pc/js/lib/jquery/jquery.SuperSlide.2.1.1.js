 ...
 * Super_slide v2.1.1 
 * 轻松解决网站大部分特效展示问题
 * 详尽信息请看官网：http://www.Super_slide2.com/
 *
 ...
 * v2.1.1：修复当调用多个Super_slide，并设置returnDefault:true 时返回defaultIndex索引错误

 */

!function (a) {
    a.fn._slide = function (b) {
        return a.fn._slide.defaults = {
            type: "_slide",
            effect: "fade",
            autoPlay: !1,
            delayTime: 500,
            ...
            var c = a.extend({}, a.fn._slide.defaults, b), d = a(this), e = c.effect, f = a(c.prevCell, d),
            ...
            var Q, t = parseInt(c.scroll), u = parseInt(c.vis), v = "false" == c.autoPlay || 0 == c.autoPlay ? !1 : !0,
                ...
                G = c._easing, H = null, I = null, J = null, K = c.titOnClassName, L = j.index(d.find("." + K)),
            ...
            var $ = function (a) {
                ...
                if (!A || M != p || a || R) {
                    if (R ? p >= 1 ? p = 1 : 0 >= p && (p = 0) : (O = p, p >= k ? p = 0 : 0 > p && (p = k - 1)), S(), null != n && _(l.children()), o[0] && (Q = o.eq(p), null != n && _(o), "_slideDown" == e ? (o.not(Q).stop(!0, !0)._slideUp(q), Q._slideDown(q, G, function () {
                            l[0] || T()
            ...
            A && ab(!0), B && d.hover(function () {
                ...
                J = setTimeout(function () {
                    p = N, A ? ab() : "_slideDown" == e ? Q._slideUp(q, U) : Q.animate({opacity: "hide"}, q, U), M = p
                }, 300)
            });
            var bb = function (a) {
...
}(jQuery), jQuery._easing.jswing = jQuery._easing.swing, jQuery.extend(jQuery._easing, {
    def: "easeOutQuad",
    swing: function (a, b, c, d, e) {
        return jQuery._easing[jQuery._easing.def](a, b, c, d, e)
    },
    ...
    easeInBounce: function (a, b, c, d, e) {
        return d - jQuery._easing.easeOutBounce(a, e - b, 0, d, e) + c
    },
    easeOutBounce: function (a, b, c, d, e) {
        return (b /= e) < 1 / 2.75 ? d * 7.5625 * b * b + c : 2 / 2.75 > b ? d * (7.5625 * (b -= 1.5 / 2.75) * b + .75) + c : 2.5 / 2.75 > b ? d * (7.5625 * (b -= 2.25 / 2.75) * b + .9375) + c : d * (7.5625 * (b -= 2.625 / 2.75) * b + .984375) + c
    },
    easeInOutBounce: function (a, b, c, d, e) {
        return e / 2 > b ? .5 * jQuery._easing.easeInBounce(a, 2 * b, 0, d, e) + c : .5 * jQuery._easing.easeOutBounce(a, 2 * b - e, 0, d, e) + .5 * d + c
    }
});